...
- [User Experience Design (UX)](#user-experience-design-ux)
  - [User Studies - Planning](#user-studies---planning)

- [Target Users](#target-users)
  - [1. Commuters](#1-commuters)
  - [2. Drivers Attending Appointments or Events](#2-drivers-attending-appointments-or-events)
  - [3. Delivery Drivers](#3-delivery-drivers)

- [Research](#research)
  - [Research Findings and Features](#research-findings-and-features)
  - [Competitor Research](#competitor-research)
  - [Competitor Research Conclusion](#competitor-research-conclusion)
...
- [Python and Django Files](#python-and-django-files)
  - [Python and Django File Functions](#python-and-django-file-functions)
  - [Main Files I Will Work With](#main-files-i-will-work-with)
  - [Django Generated Files](#django-generated-files)

- [Structure](#structure)
  - [Information Architecture](#information-architecture)
  - [Logical Organisation](#logical-organisation)
  - [User Flow](#user-flow)
...
- [Surface](#surface)
  ...
  - [Accessibility Planning](#accessibility-planning)
...
- [Database Design](#database-design)
  ...
  - [Database Fields and Data Types](#database-fields-and-data-types)

- [Validation and Security Planning](#validation-and-security-planning)
- [Responsive Design Planning](#responsive-design-planning)
- [Data and Map Planning](#data-and-map-planning)
- [Image Planning](#image-planning)
- [Verification Planning](#verification-planning)

- [Authentication and Authorisation Planning](#authentication-and-authorisation-planning)
  - [Visitors](#visitors)
  - [Registered Users](#registered-users)

- [Testing Planning](#testing-planning)
...
- [Changes During Development](#changes-during-development)
  - [Features Not Fully Implemented](#features-not-fully-implemented)
...
- [Manual Functional Testing](#manual-functional-testing)
  ...
  - [Parking Search Testing](#parking-search-testing)
  - [Favourites Testing](#favourites-testing)
  - [CRUD Testing](#crud-testing)
  - [Authentication and Authorisation Testing](#authentication-and-authorisation-testing)
  - [Error Handling Testing](#error-handling-testing)
  - [External API Failure Testing](#external-api-failure-testing)
  - [Responsiveness Testing](#responsiveness-testing)
  - [Browser Compatibility Testing](#browser-compatibility-testing)

- [HTML Validation](#html-validation)
  - [HOME Validation](#home-validation)
  - [Parking Page Validation](#parking-page-validation)
  - [Map Page Validation](#map-page-validation)
  - [Login Page Validation](#login-page-validation)
  - [Registration Page Validation](#registration-page-validation)
  - [Dashboard Page Validation](#dashboard-page-validation)
  - [Add Parking Page Validation](#add-parking-page-validation)
  - [Delete Page Validation](#delete-page-validation)

- [CSS Validation](#css-validation)

- [JavaScript JSLint Validation](#javascript-jslint-validation)
  - [Before corrections](#before-corrections)
  - [Corrections made](#corrections-made)
  - [After corrections](#after-corrections)
  - [Accessibility Testing](#accessibility-testing)

- [Automated Django Test Results](#automated-django-test-results)
  - [How I Ran the Automated Django Tests](#how-i-ran-the-automated-django-tests)
  - [Automated Test Evidence](#automated-test-evidence)
  - [Areas Covered by Automated Testing](#areas-covered-by-automated-testing)
  - [Automated Django Testing Result](#automated-django-testing-result)

- [Python PEP8 Validation](#python-pep8-validation)
  - [How I Tested the Python Code](#how-i-tested-the-python-code)
  - [Initial PEP8 Test](#initial-pep8-test)
  - [Fixing seed_parking.py](#fixing-seed_parkingpy)
  - [Project-Wide Python Validation](#project-wide-python-validation)
  - [PEP8 Testing and Fixing Process](#pep8-testing-and-fixing-process)
  - [Final PEP8 Result](#final-pep8-result)

- [Lighthouse Testing](#lighthouse-testing)
  - [Lighthouse Categories Tested](#lighthouse-categories-tested)
  - [How I Carried Out Lighthouse Testing](#how-i-carried-out-lighthouse-testing)
  - [Pages Tested](#pages-tested)
  - [Lighthouse Testing Result](#lighthouse-testing-result)

- [Final UX Evaluation](#final-ux-evaluation)
  ...
  - [Final UX Evaluation Result](#final-ux-evaluation-result)

- [User Story Testing (EVIDENCE)](#user-story-testing-evidence)
  - [Parking Search Acceptance Testing](#parking-search-acceptance-testing)
  - [Parking Results Acceptance Testing](#parking-results-acceptance-testing)
  - [Interactive Map Acceptance Testing](#interactive-map-acceptance-testing)
  - [Parking Detail Information Acceptance Testing](#parking-detail-information-acceptance-testing)
  - [Parking Verification Acceptance Testing](#parking-verification-acceptance-testing)
  - [Registration and Login Acceptance Testing](#registration-and-login-acceptance-testing)
  - [Favourites and My ParkMate Acceptance Testing](#favourites-and-my-parkmate-acceptance-testing)
  - [Add Parking Acceptance Testing](#add-parking-acceptance-testing)
  - [Edit Parking Acceptance Testing](#edit-parking-acceptance-testing)
  - [Delete Parking Acceptance Testing](#delete-parking-acceptance-testing)
  - [User Story Acceptance Testing Summary](#user-story-acceptance-testing-summary)
  - [User Story Acceptance Testing Result](#user-story-acceptance-testing-result)
  - [Final Success Criteria Evaluation](#final-success-criteria-evaluation)

- [Data Model Rationale](#data-model-rationale)
  - [Main Models](#main-models)
  - [ParkingLocation Model](#parkinglocation-model)
  - [AvailabilityReport Model](#availabilityreport-model)
  - [Data Model Overview](#data-model-overview)
  - [Data Model Diagram](#data-model-diagram)
  - [Model Relationships](#model-relationships)
  - [Relationship Rationale](#relationship-rationale)
  - [Front End and Back End Data Flow](#front-end-and-back-end-data-flow)
  - [CRUD Data Flow](#crud-data-flow)
  - [Data Model and Data Flow Evaluation](#data-model-and-data-flow-evaluation)

- [Security Features Implemented](#security-features-implemented)
  - [Environment Variables and Secret Keys](#environment-variables-and-secret-keys)
  - [Database Environment Variable](#database-environment-variable)
  - [Heroku Environment Detection](#heroku-environment-detection)
  - [HTTPS Enforcement](#https-enforcement)
  - [CSRF Protection](#csrf-protection)
  - [Security Middleware](#security-middleware)
  - [Password Security](#password-security)
  - [Production Security Evidence](#production-security-evidence)
  - [Ownership and Permissions](#ownership-and-permissions)
  - [Security Features Summary](#security-features-summary)
  - [Security Features Evaluation](#security-features-evaluation)

- [Defensive Programming](#defensive-programming)
  - [Form Validation](#form-validation)
  - [Model-Level Validation](#model-level-validation)
  - [Official Source Validation](#official-source-validation)
  - [Safe Database Retrieval](#safe-database-retrieval)
  ...
  - [Defensive Programming Evaluation](#defensive-programming-evaluation)

- [Version Control](#version-control)
  - [Version Control Workflow](#version-control-workflow)
  - [Commit Messages](#commit-messages)
  - [Why Version Control Was Important](#why-version-control-was-important)

- [Deployment Verification](#deployment-verification)
  - [Heroku Web Process](#heroku-web-process)
  - [Deployment Dependencies](#deployment-dependencies)
  - [Environment Configuration](#environment-configuration)
  - [Deployment Verification Process](#deployment-verification-process)
  - [Health Check](#health-check)
  - [Deployed Application Evidence](#deployed-application-evidence)
  - [Deployment Verification Result](#deployment-verification-result)

- [Code Quality and Organisation](#code-quality-and-organisation)
  - [Full Project Structure](#full-project-structure)
  - [Django Application Organisation](#django-application-organisation)
  - [Django Project Organisation](#django-project-organisation)
  - [Template Organisation](#template-organisation)
  - [Static File Organisation](#static-file-organisation)
  - [Testing Evidence Organisation](#testing-evidence-organisation)
  - [Separation of Responsibilities](#separation-of-responsibilities)
  - [Reusable Backend Logic](#reusable-backend-logic)
  - [Code Validation and Quality Checks](#code-validation-and-quality-checks)
  - [File and Naming Conventions](#file-and-naming-conventions)
  - [Naming Convention Summary](#naming-convention-summary)
  - [Code Quality and Organisation Evaluation](#code-quality-and-organisation-evaluation)

- [Bugs and Fixes](#bugs-and-fixes)
  - [Parking List Template Fixes](#parking-list-template-fixes)
  - [Parking Map Template Fixes](#parking-map-template-fixes)
  - [Additional Code Quality Improvements](#additional-code-quality-improvements)
...
- [Credits and Attribution](#credits-and-attribution)
  ...
  - [Code and Learning Resources](#code-and-learning-resources)
  - [AI / Copilot Assistance](#ai--copilot-assistance)
  - [Final Project Evaluation](#final-project-evaluation)

- [Project Strengths](#project-strengths)
  - [Full-Stack Django Implementation](#full-stack-django-implementation)
  - [Complete CRUD Functionality](#complete-crud-functionality)
  - [Authentication and Authorisation](#authentication-and-authorisation)
  - [Official and Community Parking Separation](#official-and-community-parking-separation)
  - [Search Functionality](#search-functionality)
  - [Interactive Map](#interactive-map)
  - [External API Resilience](#external-api-resilience)
  - [Responsive Design](#responsive-design)
  - [Accessibility Consideration](#accessibility-consideration)
  - [Extensive Testing](#extensive-testing)

- [Project Limitations](#project-limitations)
  - [Stored Parking Coverage](#stored-parking-coverage)
  - [No Live Parking Occupancy](#no-live-parking-occupancy)
  - [Search Is Not Full Geocoding](#search-is-not-full-geocoding)
  - [External Parking Images](#external-parking-images)
  - [Official Data Requires Maintenance](#official-data-requires-maintenance)
  - [Community Data Requires Trust and Moderation](#community-data-requires-trust-and-moderation)
  - [Limited Automated Test Coverage](#limited-automated-test-coverage)
  - [Parking Result Scalability](#parking-result-scalability)
  - [External Map Dependency](#external-map-dependency)
  - [No In-App Parking Payment](#no-in-app-parking-payment)
  - [Limitations Summary](#limitations-summary)

- [Final Project Evaluation Result](#final-project-evaluation-result)
## Description
